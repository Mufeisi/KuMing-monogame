...
namespace Client.MirControls
{
    public class MirControl : IDisposable
    {
        ...
        { 
            get { return Parent == null ? Location : Parent.DisplayLocation.Add(Location); } 
        }
        /// <summary>
        /// 封装位置+大小
        /// </summary>
        ...
        protected Vortice.Direct3D11.ID3D11Texture2D ControlTexture;
        ...
        protected virtual void CreateTexture()
        {
            ...
            if (ControlTexture == null)
            {
                ...
                //ControlTexture = DXManager.CreateTexture_DepthStencil((uint)Size.Width, (uint)Size.Height);
                TextureSize = Size;
            }
            ...
            ////debug:
            //CMain.SaveError($"MirControl.CreateTexture()：{ControlTexture.NativePointer}-{ControlTexture.Description.BindFlags}-{ControlTexture.Description.CPUAccessFlags}" +
