...
{
    internal static class PcBootstrapAcceptanceContext
    {
        private static readonly AsyncLocal<IReadOnlyDictionary<string, BootstrapManifestTrustedKey>> CurrentValue = new();
