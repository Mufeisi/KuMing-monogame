...
namespace ClientPackets
{
    ...
    public sealed class NpcConversationClosed : Packet
    {
        public override short Index { get { return (short)ClientPacketIds.NpcConversationClosed; } }
    ...
    public sealed class Fg : Packet
    {
        public override short Index { get { return (short)ClientPacketIds.Fg; } }

        public FgType Type;
        public string result;
        protected override void ReadPacket(BinaryReader reader)
        {
            Type = (FgType)reader.ReadByte();
