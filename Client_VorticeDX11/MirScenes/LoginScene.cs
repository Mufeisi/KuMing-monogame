...
namespace Client.MirScenes
{
    public sealed class LoginScene : MirScene
    {
        ...
        public LoginScene()
        {
            ...
            CMain.SaveError(DXManager.PrintParentMethod() + $"LoginScene开始初始化");
            Client.Utils.ResolutionTrace.LogClientState("LoginScene.ctor", "Begin");
            ...
            Client.Utils.ResolutionTrace.LogClientState("LoginScene.ctor", $"Background.Size={_background.Size.Width}x{_background.Size.Height}, LoginDialog.Visible={_login.Visible}");
