    ...
    public sealed class OptionDialog : MirImageControl
    {
        ...
        public OptionDialog()
        {
            ...
            SmoothMoveOn.Click += (o, e) =>
            {
                ...
                GameScene.Scene.ChatDialog.ReceiveChat("[平滑移动: 开]", ChatType.Hint);
            };
            ...
            SmoothMoveOff.Click += (o, e) =>
            {
                ...
                GameScene.Scene.ChatDialog.ReceiveChat("[平滑移动: 关]", ChatType.Hint);
            };
        ...
        private void OptionPanel_BeforeDraw(object sender, EventArgs e)
        {
            ...
            {
                SmoothMoveOn.Index = 853;
                SmoothMoveOff.Index = 848;
            }
            else
            {
                SmoothMoveOn.Index = 851;
                SmoothMoveOff.Index = 850;
            }
