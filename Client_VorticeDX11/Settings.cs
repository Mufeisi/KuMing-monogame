...
namespace Client
{
    class Settings
    {
        ...
        public static bool ResolutionTraceEnabled = false;
        public const int MinViewZoomPercent = 70;
        public const int MaxViewZoomPercent = 150;
        public const int DefaultViewZoomPercent = 100;
        public static int ViewZoomPercent = DefaultViewZoomPercent;

        public static void ApplyResolutionSetting()
        {
            ApplyResolutionSetting(Resolution);
        }

        public static void ApplyResolutionSetting(int resolution)
        {
            Resolution = NormalizeResolution(resolution);
            var size = GetResolutionSize();
            ScreenWidth = size.Width;
            ScreenHeight = size.Height;
            Client.Utils.ResolutionTrace.Log("Settings.ApplyResolutionSetting", $"Input={resolution}, Normalized={Resolution}, Screen={ScreenWidth}x{ScreenHeight}");
        }
        ...
        public static Size GetResolutionSize()
        {
            ...
            {
                1280 => new Size(1280, 720),
                1366 => new Size(1366, 768),
                1920 => new Size(1920, 1080),
                1024 => new Size(1024, 768),
                _ => new Size(1024, 768),
            };
        }
        ...
        //Interface / UI
        public static string UIProfileId = "Classic";
        ...
        public static bool BootstrapAutoDownload = false;
        public static bool BootstrapVerifySha256 = true;
        public static int BootstrapRetryCount = 3;
        ...
        public static void Load()
        {
            ...
            Client.Utils.ResolutionTrace.Log("Settings.Load", $"Graphics Resolution={Resolution}, FullScreen={FullScreen}, Borderless={Borderless}, TopMost={TopMost}, MouseClip={MouseClip}, FPSCap={FPSCap}");
            ...
            BootstrapVerifySha256 = Reader.ReadBoolean("Bootstrap", "VerifySha256", BootstrapVerifySha256);
            BootstrapRetryCount = Reader.ReadInt32("Bootstrap", "RetryCount", BootstrapRetryCount);
            ...
            ViewZoomPercent = Math.Clamp(Reader.ReadInt32("Game", "ViewZoomPercent", ViewZoomPercent), MinViewZoomPercent, MaxViewZoomPercent);
        ...
        public static void Save()
        {
            ...
            Reader.Write("Bootstrap", "AutoDownload", BootstrapAutoDownload);
            Reader.Write("Bootstrap", "VerifySha256", BootstrapVerifySha256);
            Reader.Write("Bootstrap", "RetryCount", BootstrapRetryCount);
            ...
            Reader.Write("Game", "ViewZoomPercent", Math.Clamp(ViewZoomPercent, MinViewZoomPercent, MaxViewZoomPercent));
