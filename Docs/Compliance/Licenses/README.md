...
本目录随 PC、Android、iOS 与 Windows 服务端发布。

- `MIT.txt`、`Apache-2.0.txt`、`BSD-2-Clause.txt`、`Zlib.txt`、`MS-PL.txt`、`EPL-2.0.txt`、`MPL-2.0.txt`：SPDX 依赖清单中出现的标准许可证正文。
- `Microsoft-Windows-SDK-License.txt`：Windows SDK、Win32 Metadata、Win32 Docs 与 WDK Metadata 相关包的微软许可证。
