...
| 当前产品任务 | [`requirements/LEG-08-技能可视化与安全编辑.md`](requirements/LEG-08-技能可视化与安全编辑.md) | LEG-08 已激活；`GATE-SKILL-READONLY` 已关闭，下一切片为 `SKILL-03` |
...
当前活动产品任务仅为 LEG-08；范围、切片和状态以其专项规格为唯一事实源。其他新功能、修复或优化仍须先指定对应 PRD、Issue、规格或明确验收标准。
