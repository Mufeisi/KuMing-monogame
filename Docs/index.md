...
| 当前产品任务 | [`requirements/LEG-07-自定义游戏GUI.md`](requirements/LEG-07-自定义游戏GUI.md) | LEG-07 已激活；`GUI-CORE-01..04` 与 `GUI-01..04` 已完成，`GATE-GUI-CORE` 已关闭，下一切片为 `GUI-05` 校验、签名与资源限制 |
