...
public sealed class LingFengEnvirFileClassifierTests
{
    ...
    [InlineData("QuestDiary/活动/UserData/领取记录.txt", LingFengEnvirFileOwner.RuntimeData, false, null)]
    [InlineData("QuestDiary/活动/GuildBase/Guilds/红方行会.ini", LingFengEnvirFileOwner.RuntimeData, false, null)]
    [InlineData("QuestDiary/活动/GuildBase/Guilds/红方行会.txt", LingFengEnvirFileOwner.RuntimeData, false, null)]
    ...
    [InlineData("MonItems/蜗牛备份_QQ群835162076/剑阁守灵.txt", LingFengEnvirFileOwner.BackupOrArchive, false, null)]
