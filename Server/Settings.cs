...
namespace Server
{
    public static class Settings
    {
        ...
        public static bool AutoImportLegacyOnEmpty = true;

        //Accounts（关系表化后，默认优先从关系表启动；不再依赖 accounts blob）

        //World（关系表化后，默认不再依赖 world blob；保留开关便于过渡/回滚对照）
        public static bool WorldLegacyBlobReadFallbackEnabled = false;
        public static bool WorldLegacyBlobWriteEnabled = false;
        ...
        {            
            ...
            AutoImportLegacyOnEmpty = Reader.ReadBoolean("Database", "AutoImportLegacyOnEmpty", AutoImportLegacyOnEmpty);
            WorldLegacyBlobReadFallbackEnabled = Reader.ReadBoolean("Database", "WorldLegacyBlobReadFallbackEnabled", WorldLegacyBlobReadFallbackEnabled);
            WorldLegacyBlobWriteEnabled = Reader.ReadBoolean("Database", "WorldLegacyBlobWriteEnabled", WorldLegacyBlobWriteEnabled);
        ...
        public static void Save()
        {
            ...
            Reader.Write("Database", "AutoImportLegacyOnEmpty", AutoImportLegacyOnEmpty);
            Reader.Write("Database", "WorldLegacyBlobReadFallbackEnabled", WorldLegacyBlobReadFallbackEnabled);
            Reader.Write("Database", "WorldLegacyBlobWriteEnabled", WorldLegacyBlobWriteEnabled);
