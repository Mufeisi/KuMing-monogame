...
namespace Server
{
    public static class Settings
    {
        ...
        public static string GMPassword = "@123456";
        ...
        public static string MicroAuthor = "MicroUser";
        ...
        public static bool CSharpScriptsFallbackToTxt = false;
        public static bool CSharpScriptsSkipTxtNpcLoad = true;
        public static string CSharpScriptsSkipTxtNpcLoadNpcFiles = string.Empty;
        public static bool CSharpScriptsLogDiagnostics = true;
        public static string CSharpScriptsPreferKeyPrefixes = string.Empty;
        public static string CSharpScriptsDisabledKeys = string.Empty;
        public static bool CSharpScriptsNoTxtFallbackEnabled = false;
        public static string CSharpScriptsNoTxtFallbackKeyPrefixes = string.Empty;
        public static string CSharpScriptsNoTxtFallbackKeys = string.Empty;

        //AI Scripts
        public static bool AiScriptsEnabled = false;
        public static string AiScriptsProvider = "Disabled";
        ...
        public static bool TxtScriptsLogDispatch = false;
        public static bool TxtScriptsEnableInsertInclude = true;

        //Legacy Txt Scripts（缺失时自动恢复）
        // 说明：某些发布包可能只包含 Envir 目录结构，但缺少完整的 *.txt 脚本文件。
        //      若同目录存在 _Legacy*TxtBackup 备份，则在启动时自动从最新备份补齐缺失文件（默认不覆盖已有非空文件）。
        public static bool TxtScriptsAutoRestoreFromLegacyBackupEnabled = false;
        public static bool TxtScriptsAutoRestoreOverwriteEmptyFiles = false;
        public static bool TxtScriptsAutoRestoreLog = false;

        //Legacy Txt Scripts (运行时使用统计)
        public static bool TxtScriptsUsageTraceEnabled = false;
        public static int TxtScriptsUsageTraceAutoDumpSeconds = 60;
        public static int TxtScriptsUsageTraceMaxSourcesPerKey = 10;

        //Scripts Runtime Metrics（统计 legacy 解析器 / C# handler 命中与耗时）
        public static bool ScriptsRuntimeMetricsEnabled = false;
        public static int ScriptsRuntimeMetricsAutoDumpSeconds = 0;
        public static int ScriptsRuntimeMetricsMaxKeys = 2000;

        //Database
        public static int SaveDelay = 5;
        public static short CredxGold = 30;
        public static string DatabaseProvider = "Sqlite"; // Sqlite|MySql
        public static string SqliteDirectory = @".\Data";
        public static string MySqlIdentityConnectionString = string.Empty;
        public static string MySqlCharacterConnectionString = string.Empty;
        public static string MySqlWorldConnectionString = string.Empty;

        //MySQL（连接池/断线容灾）
        // -1=不覆盖（使用连接串/驱动默认），0=禁用，1=启用
        public static int MySqlPooling = -1;
        public static int MySqlMinPoolSize = 0;
        public static int MySqlMaxPoolSize = 0;
        public static int MySqlConnectionTimeoutSeconds = 0;
        public static int MySqlKeepAliveSeconds = 0;
        public static int MySqlConnectionIdleTimeoutSeconds = 0;
        public static int MySqlConnectionLifeTimeSeconds = 0;

        public static bool AutoApplySchemaOnStartup = true;
        public static int SaveBatchSize = 2000;

        //保存容灾（失败重试/降级/落盘日志/停服保护）
        public static int SaveFailureMaxConsecutive = 3;
        public static int SaveFailureCooldownSeconds = 60;
        public static bool SaveFailureLogToFile = true;
        public static string SaveFailureLogDir = @".\Logs\Persistence";
        public static bool BlockShutdownOnSaveFailures = true;
        public static int BlockShutdownOnSaveFailuresThreshold = 3;
        ...
        {            
            ...
            CSharpScriptsFallbackToTxt = Reader.ReadBoolean("CSharpScripts", "CSharpScriptsFallbackToTxt", CSharpScriptsFallbackToTxt);
            CSharpScriptsSkipTxtNpcLoad = Reader.ReadBoolean("CSharpScripts", "CSharpScriptsSkipTxtNpcLoad", CSharpScriptsSkipTxtNpcLoad);
            CSharpScriptsSkipTxtNpcLoadNpcFiles = Reader.ReadString("CSharpScripts", "CSharpScriptsSkipTxtNpcLoadNpcFiles", CSharpScriptsSkipTxtNpcLoadNpcFiles);
            CSharpScriptsLogDiagnostics = Reader.ReadBoolean("CSharpScripts", "CSharpScriptsLogDiagnostics", CSharpScriptsLogDiagnostics);
            CSharpScriptsPreferKeyPrefixes = Reader.ReadString("CSharpScripts", "CSharpScriptsPreferKeyPrefixes", CSharpScriptsPreferKeyPrefixes);
            CSharpScriptsDisabledKeys = Reader.ReadString("CSharpScripts", "CSharpScriptsDisabledKeys", CSharpScriptsDisabledKeys);
            CSharpScriptsNoTxtFallbackEnabled = Reader.ReadBoolean("CSharpScripts", "CSharpScriptsNoTxtFallbackEnabled", CSharpScriptsNoTxtFallbackEnabled);
            CSharpScriptsNoTxtFallbackKeyPrefixes = Reader.ReadString("CSharpScripts", "CSharpScriptsNoTxtFallbackKeyPrefixes", CSharpScriptsNoTxtFallbackKeyPrefixes);
            CSharpScriptsNoTxtFallbackKeys = Reader.ReadString("CSharpScripts", "CSharpScriptsNoTxtFallbackKeys", CSharpScriptsNoTxtFallbackKeys);

            //AI Scripts
            AiScriptsEnabled = Reader.ReadBoolean("AiScripts", "AiScriptsEnabled", AiScriptsEnabled);
            ...
            TxtScriptsAutoRestoreFromLegacyBackupEnabled = Reader.ReadBoolean("TxtScripts", "TxtScriptsAutoRestoreFromLegacyBackupEnabled", TxtScriptsAutoRestoreFromLegacyBackupEnabled);
            TxtScriptsAutoRestoreOverwriteEmptyFiles = Reader.ReadBoolean("TxtScripts", "TxtScriptsAutoRestoreOverwriteEmptyFiles", TxtScriptsAutoRestoreOverwriteEmptyFiles);
            TxtScriptsAutoRestoreLog = Reader.ReadBoolean("TxtScripts", "TxtScriptsAutoRestoreLog", TxtScriptsAutoRestoreLog);
            TxtScriptsUsageTraceEnabled = Reader.ReadBoolean("TxtScripts", "TxtScriptsUsageTraceEnabled", TxtScriptsUsageTraceEnabled);
            TxtScriptsUsageTraceAutoDumpSeconds = Reader.ReadInt32("TxtScripts", "TxtScriptsUsageTraceAutoDumpSeconds", TxtScriptsUsageTraceAutoDumpSeconds);
            TxtScriptsUsageTraceMaxSourcesPerKey = Reader.ReadInt32("TxtScripts", "TxtScriptsUsageTraceMaxSourcesPerKey", TxtScriptsUsageTraceMaxSourcesPerKey);

            //Scripts Runtime Metrics
            ScriptsRuntimeMetricsEnabled = Reader.ReadBoolean("ScriptMetrics", "Enabled", ScriptsRuntimeMetricsEnabled);
            ScriptsRuntimeMetricsAutoDumpSeconds = Math.Max(0, Reader.ReadInt32("ScriptMetrics", "AutoDumpSeconds", ScriptsRuntimeMetricsAutoDumpSeconds));
            ScriptsRuntimeMetricsMaxKeys = Math.Max(0, Reader.ReadInt32("ScriptMetrics", "MaxKeys", ScriptsRuntimeMetricsMaxKeys));
            ...
            SqliteDirectory = Reader.ReadString("Database", "SqliteDirectory", SqliteDirectory);
            MySqlIdentityConnectionString = Reader.ReadString("Database", "MySqlIdentityConnectionString", MySqlIdentityConnectionString);
            MySqlCharacterConnectionString = Reader.ReadString("Database", "MySqlCharacterConnectionString", MySqlCharacterConnectionString);
            MySqlWorldConnectionString = Reader.ReadString("Database", "MySqlWorldConnectionString", MySqlWorldConnectionString);
            ...
            MySqlConnectionTimeoutSeconds = Reader.ReadInt32("Database", "MySqlConnectionTimeoutSeconds", MySqlConnectionTimeoutSeconds);
            MySqlKeepAliveSeconds = Reader.ReadInt32("Database", "MySqlKeepAliveSeconds", MySqlKeepAliveSeconds);
            MySqlConnectionIdleTimeoutSeconds = Reader.ReadInt32("Database", "MySqlConnectionIdleTimeoutSeconds", MySqlConnectionIdleTimeoutSeconds);
            MySqlConnectionLifeTimeSeconds = Reader.ReadInt32("Database", "MySqlConnectionLifeTimeSeconds", MySqlConnectionLifeTimeSeconds);
            AutoApplySchemaOnStartup = Reader.ReadBoolean("Database", "AutoApplySchemaOnStartup", AutoApplySchemaOnStartup);
            SaveBatchSize = Reader.ReadInt32("Database", "SaveBatchSize", SaveBatchSize);
            SaveFailureMaxConsecutive = Reader.ReadInt32("Database", "SaveFailureMaxConsecutive", SaveFailureMaxConsecutive);
            SaveFailureCooldownSeconds = Reader.ReadInt32("Database", "SaveFailureCooldownSeconds", SaveFailureCooldownSeconds);
            SaveFailureLogToFile = Reader.ReadBoolean("Database", "SaveFailureLogToFile", SaveFailureLogToFile);
            SaveFailureLogDir = Reader.ReadString("Database", "SaveFailureLogDir", SaveFailureLogDir);
            BlockShutdownOnSaveFailures = Reader.ReadBoolean("Database", "BlockShutdownOnSaveFailures", BlockShutdownOnSaveFailures);
            BlockShutdownOnSaveFailuresThreshold = Reader.ReadInt32("Database", "BlockShutdownOnSaveFailuresThreshold", BlockShutdownOnSaveFailuresThreshold);
        ...
        public static void Save()
        {
            ...
            Reader.Write("CSharpScripts", "CSharpScriptsFallbackToTxt", CSharpScriptsFallbackToTxt);
            Reader.Write("CSharpScripts", "CSharpScriptsSkipTxtNpcLoad", CSharpScriptsSkipTxtNpcLoad);
            Reader.Write("CSharpScripts", "CSharpScriptsSkipTxtNpcLoadNpcFiles", CSharpScriptsSkipTxtNpcLoadNpcFiles);
            Reader.Write("CSharpScripts", "CSharpScriptsLogDiagnostics", CSharpScriptsLogDiagnostics);
            Reader.Write("CSharpScripts", "CSharpScriptsPreferKeyPrefixes", CSharpScriptsPreferKeyPrefixes);
            Reader.Write("CSharpScripts", "CSharpScriptsDisabledKeys", CSharpScriptsDisabledKeys);
            Reader.Write("CSharpScripts", "CSharpScriptsNoTxtFallbackEnabled", CSharpScriptsNoTxtFallbackEnabled);
            Reader.Write("CSharpScripts", "CSharpScriptsNoTxtFallbackKeyPrefixes", CSharpScriptsNoTxtFallbackKeyPrefixes);
            Reader.Write("CSharpScripts", "CSharpScriptsNoTxtFallbackKeys", CSharpScriptsNoTxtFallbackKeys);

            //AI Scripts
            Reader.Write("AiScripts", "AiScriptsEnabled", AiScriptsEnabled);
            Reader.Write("AiScripts", "AiScriptsProvider", AiScriptsProvider);
            ...
            Reader.Write("TxtScripts", "TxtScriptsAutoRestoreFromLegacyBackupEnabled", TxtScriptsAutoRestoreFromLegacyBackupEnabled);
            Reader.Write("TxtScripts", "TxtScriptsAutoRestoreOverwriteEmptyFiles", TxtScriptsAutoRestoreOverwriteEmptyFiles);
            Reader.Write("TxtScripts", "TxtScriptsAutoRestoreLog", TxtScriptsAutoRestoreLog);
            Reader.Write("TxtScripts", "TxtScriptsUsageTraceEnabled", TxtScriptsUsageTraceEnabled);
            Reader.Write("TxtScripts", "TxtScriptsUsageTraceAutoDumpSeconds", TxtScriptsUsageTraceAutoDumpSeconds);
            Reader.Write("TxtScripts", "TxtScriptsUsageTraceMaxSourcesPerKey", TxtScriptsUsageTraceMaxSourcesPerKey);

            //Scripts Runtime Metrics
            Reader.Write("ScriptMetrics", "Enabled", ScriptsRuntimeMetricsEnabled);
            Reader.Write("ScriptMetrics", "AutoDumpSeconds", ScriptsRuntimeMetricsAutoDumpSeconds);
            Reader.Write("ScriptMetrics", "MaxKeys", ScriptsRuntimeMetricsMaxKeys);
            ...
            Reader.Write("Database", "SqliteDirectory", SqliteDirectory);
            Reader.Write("Database", "MySqlIdentityConnectionString", MySqlIdentityConnectionString);
            Reader.Write("Database", "MySqlCharacterConnectionString", MySqlCharacterConnectionString);
            Reader.Write("Database", "MySqlWorldConnectionString", MySqlWorldConnectionString);
            ...
            Reader.Write("Database", "MySqlConnectionTimeoutSeconds", MySqlConnectionTimeoutSeconds);
            Reader.Write("Database", "MySqlKeepAliveSeconds", MySqlKeepAliveSeconds);
            Reader.Write("Database", "MySqlConnectionIdleTimeoutSeconds", MySqlConnectionIdleTimeoutSeconds);
            Reader.Write("Database", "MySqlConnectionLifeTimeSeconds", MySqlConnectionLifeTimeSeconds);
            Reader.Write("Database", "AutoApplySchemaOnStartup", AutoApplySchemaOnStartup);
            Reader.Write("Database", "SaveBatchSize", SaveBatchSize);
            Reader.Write("Database", "SaveFailureMaxConsecutive", SaveFailureMaxConsecutive);
            Reader.Write("Database", "SaveFailureCooldownSeconds", SaveFailureCooldownSeconds);
            Reader.Write("Database", "SaveFailureLogToFile", SaveFailureLogToFile);
            Reader.Write("Database", "SaveFailureLogDir", SaveFailureLogDir);
            Reader.Write("Database", "BlockShutdownOnSaveFailures", BlockShutdownOnSaveFailures);
            Reader.Write("Database", "BlockShutdownOnSaveFailuresThreshold", BlockShutdownOnSaveFailuresThreshold);
