    ...
    public class MirConnection
    {
        ...
        public void Process()
        {
            ...
            while (!_sendList.IsEmpty)
            {
                ...
                PacketTraceLogger.Trace("SEND", p, this, packetBytes.Length);
        ...
        public void MailCost(C.MailCost p)
        {
            ...
            uint cost = Player.GetMailCost(p.ItemsIdx, p.Gold, p.Stamped, Server.Scripting.MailCostOperation.Preview);
