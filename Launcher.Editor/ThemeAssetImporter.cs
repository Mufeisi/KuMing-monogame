...
public static class ThemeAssetImporter
{
    ...
    public static string Import(string projectRoot, string sourceFile, bool optimize = true)
    {
        ...
        string name = optimize && extension.Equals(".bmp", StringComparison.OrdinalIgnoreCase)
        ...
        if (optimize && extension.Equals(".bmp", StringComparison.OrdinalIgnoreCase))
        {
